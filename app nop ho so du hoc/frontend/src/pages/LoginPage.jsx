                ...
                <div className="card">
                    <div className="card-head">
                        ...
                        <p className="card-subtitle">
                            {mode === "login"
                                ...
                                : role === "student"
                                  ? "Nhap thong tin de tao tai khoan. Tai khoan sinh vien se can duoc phe duyet truoc khi su dung."
                                  : "Nhap thong tin de tao tai khoan. Tai khoan quan tri se can duoc phe duyet truoc khi su dung."}
                        </p>
                    </div>
                    ...
                    {mode === "register" && (
                        <p className="auth-message" style={{ marginTop: 12 }}>
                            Tai khoan moi se duoc tao o trang thai cho phe duyet. Chon dung vai tro truoc khi gui dang ky.
                        </p>
                    )}
